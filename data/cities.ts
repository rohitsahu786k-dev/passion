...
export const cities: City[] = [
  ...
  { name: 'Chennai', slug: 'chennai', state: 'Tamil Nadu', phone: '+919999900108', whatsapp: '919999900108', address: 'T. Nagar, Chennai', rating: 4.6, reviewCount: 143, landmarks: ['T. Nagar', 'Adyar', 'Anna Nagar'], summary: 'CityStyle Chennai connects users with verified lifestyle, grooming, and event specialists.' },
