...
export default function KanpurEscortPage() {
  const phone = '+919999900120';
  const whatsapp = '919999900120';
  ...
  const faqs = [
    {
      ...
      answer: "Girls of Passion is a professional adult companionship booking support platform in Kanpur for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "How to book a call girl in Kanpur?",
      answer: "Call us or send a message on WhatsApp. Share your current hotel area, and we will share verified profiles."
    },
    {
      question: "Which areas do you cover in Kanpur?",
      answer: "We serve Swaroop Nagar, Civil Lines, Kakadeo, and Kanpur Mall Road hotels."
    },
    {
      question: "Is my personal information protected?",
      answer: "Yes. We delete all booking records and chats after the meet to protect your identity."
    },
    {
      question: "Can I pay cash in Kanpur?",
      answer: "Yes, cash payment is accepted on meet."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.6}
        reviewCount={112}
        url="https://www.girlsofpassion.in/kanpur-escort-service/"
        faqs={faqs}
      />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 py-2.5 text-center text-xs font-semibold uppercase tracking-widest text-black">
          💎 Premium & Discreet 100% Verified Profiles in Kanpur
        </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Kanpur
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Kanpur Escort Service</strong> and <strong className="text-white">Kanpur Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Kanpur area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Visiting Kanpur for business or staying in a hotel near Swaroop Nagar or Civil Lines? A verified companion can make your industrial trip much more relaxing. Book premium profiles directly with us.
                </p>
                <p>
                  Kanpur is a major industrial city in Uttar Pradesh, hosting merchants, business owners, and corporate executives.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near Swaroop Nagar, Civil Lines & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">Swaroop Nagar, Civil Lines, Kakadeo, Mall Road</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Kanpur Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We understand that local business executives require complete privacy. We ensure all bookings are coordinated quietly, with secure communication.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                We provide booking support in major commercial hotels near Swaroop Nagar, Civil Lines, and Mall Road.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Kanpur</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Kanpur:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["Swaroop Nagar","Civil Lines","Kakadeo","Mall Road"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Kanpur Escorts Today</h3>
