...
export default async function Home() {
  ...
  const cityPageLinks: Record<string, string> = {
    ...
    'Mumbai': '/mumbai-escort-service/',
    'Jaipur': '/jaipur-escort-service/',
    'Udaipur': '/udaipur-escort-service/',
    'Goa': '/goa-escort-service/',
    'Hyderabad': '/hyderabad-escort-service/',
    'Pune': '/pune-escort-service/',
    'Noida': '/noida-escort-service/',
    'Manali': '/manali-escort-service/',
    'Jodhpur': '/jodhpur-escort-service/',
    'Lucknow': '/lucknow-escort-service/',
    'Kanpur': '/kanpur-escort-service/',
    'Surat': '/surat-escort-service/',
    'Rishikesh': '/rishikesh-escort-service/',
    'Nathdwara': '/nathdwara-escort-service/',
    'Mount Abu': '/maunt-abu-escort-service/',
    'Jawai': '/jawai-escort-service/',
    'Chennai': '/chennai-escort-service/',
    'Dehradun': '/dehradun-escort-service/',
    'Indore': '/indore-escort-service/',
  };
  ...
  const faqs = [
    ...
    {
      question: "How much does escort service cost in India?",
      answer: "Pricing for escort service in India varies by city, companion category, duration, and location. Girls of Passion shares clear pricing details before confirmation so clients can plan without surprises. Contact us via call or WhatsApp to get current rate information for your city."
    },
    {
      question: "What is VIP escort service in India?",
      answer: "VIP escort service in India refers to premium-tier adult companionship with high-quality, well-presented companion profiles. Girls of Passion offers VIP companion options for clients who prefer a more exclusive, refined experience at luxury hotels, resorts, and private locations across India."
    },
    {
      question: "Which city has the best escort service in India?",
      answer: "Girls of Passion offers premium escort services across Delhi, Mumbai, Goa, Jaipur, Udaipur, Hyderabad, Pune, Noida, Manali, Jodhpur, Indore, Lucknow, Rishikesh, Guwahati, Surat, Kanpur, Dehradun, and more. Each city has curated, verified profiles with 24x7 booking support."
    },
    {
      question: "How to book call girl service in India?",
      answer: "To book a call girl service in India through Girls of Passion, simply contact our support team via phone call or WhatsApp. Share your city, preferred location, timing, and requirements. Our team will check available profiles and confirm details before proceeding."
    },
    {
      question: "Is hotel escort service available in India?",
      answer: "Yes, Girls of Passion provides hotel escort service across major Indian cities. Whether you are staying at a 3-star, 4-star, or 5-star hotel in Delhi, Mumbai, Goa, Jaipur, or any other covered city, our team coordinates discreet in-room companionship booking. Share your hotel name and location to check availability."
    }
  ];
  ...
  const citiesItemListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Escort Service Available Cities in India',
    description: 'Cities where Girls of Passion provides premium escort companionship services',
    numberOfItems: Object.keys(cityPageLinks).length,
    itemListElement: Object.entries(cityPageLinks).map(([name, url], idx) => ({
      '@type': 'ListItem',
      position: idx + 1,
      name: `${name} Escort Service`,
      url: `${siteUrl}${url}`,
    })),
  };
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(citiesItemListSchema) }} />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <section className="py-20 border-b border-neutral-900 bg-neutral-900/20">
          <div className="container-shell">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {[
                'Delhi', 'Mumbai', 'Jaipur', 'Udaipur', 'Goa', 'Hyderabad',
                'Pune', 'Noida', 'Manali', 'Jodhpur', 'Lucknow', 'Kanpur',
                'Surat', 'Rishikesh', 'Nathdwara', 'Mount Abu', 'Jawai',
                'Luxury hotels', 'Private residences', 'Resorts and travel stays'
              ].map((loc) => {
                const href = cityPageLinks[loc];
                const inner = (
                  <>
                    ...
                    <div>
                      ...
                      <span className="block text-[10px] text-neutral-400">{href ? `${loc} Escort Service` : 'Available Location'}</span>
                    </div>
                  </>
                );
                return href ? (
                  <Link key={loc} href={href} className="flex items-center gap-3 rounded-lg border border-neutral-800/80 bg-neutral-900/40 p-4 hover:border-amber-500/50 hover:bg-amber-500/5 transition-all">
                    {inner}
                  </Link>
                ) : (
                  <div key={loc} className="flex items-center gap-3 rounded-lg border border-neutral-800/80 bg-neutral-900/40 p-4">
                    {inner}
                  </div>
                );
              })}
        ...
        {/* People Also Search For – Internal Linking Hub */}
        <section className="py-16 bg-neutral-950 border-b border-neutral-900">
          <div className="container-shell">
            <div className="mb-10 text-center">
              <span className="text-xs font-semibold uppercase tracking-wider text-amber-500">Explore by City & Service</span>
              <h2 className="mt-2 text-3xl font-bold text-white">People Also Search For</h2>
              <div className="mt-2 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-3 text-sm text-neutral-400">Explore escort services across India's top cities and service categories</p>
            </div>

            {/* City-wise escort service links */}
            <div className="mb-8">
              <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                <MapPin size={14} className="text-amber-500" />
                Escort Service by City
              </h3>
              <div className="flex flex-wrap gap-2">
                {[
                  { label: 'Delhi Escort Service', href: '/delhi-escort-service/' },
                  { label: 'Mumbai Escort Service', href: '/mumbai-escort-service/' },
                  { label: 'Goa Escort Service', href: '/goa-escort-service/' },
                  { label: 'Jaipur Escort Service', href: '/jaipur-escort-service/' },
                  { label: 'Udaipur Escort Service', href: '/udaipur-escort-service/' },
                  { label: 'Hyderabad Escort Service', href: '/hyderabad-escort-service/' },
                  { label: 'Pune Escort Service', href: '/pune-escort-service/' },
                  { label: 'Noida Escort Service', href: '/noida-escort-service/' },
                  { label: 'Manali Escort Service', href: '/manali-escort-service/' },
                  { label: 'Jodhpur Escort Service', href: '/jodhpur-escort-service/' },
                  { label: 'Indore Escort Service', href: '/indore-escort-service/' },
                  { label: 'Lucknow Escort Service', href: '/lucknow-escort-service/' },
                  { label: 'Rishikesh Escort Service', href: '/rishikesh-escort-service/' },
                  { label: 'Guwahati Escort Service', href: '/guwahati-escort-service/' },
                  { label: 'Surat Escort Service', href: '/surat-escort-service/' },
                  { label: 'Kanpur Escort Service', href: '/kanpur-escort-service/' },
                  { label: 'Dehradun Escort Service', href: '/dehradun-escort-service/' },
                  { label: 'Ajmer Escort Service', href: '/ajmer-escort-service/' },
                  { label: 'Daman Escort Service', href: '/daman-escort-service/' },
                  { label: 'Chennai Escort Service', href: '/chennai-escort-service/' },
                  { label: 'Nathdwara Escort Service', href: '/nathdwara-escort-service/' },
                  { label: 'Mount Abu Escort Service', href: '/maunt-abu-escort-service/' },
                  { label: 'Jawai Escort Service', href: '/jawai-escort-service/' },
                  { label: 'India Escort Service', href: '/india-escort-service/' },
                ].map(({ label, href }) => (
                  <Link
                    key={href}
                    href={href}
                    className="inline-flex items-center gap-1.5 rounded-full border border-neutral-800 bg-neutral-900/60 px-3 py-1.5 text-xs font-medium text-neutral-300 hover:border-amber-500/60 hover:text-amber-400 hover:bg-neutral-900 transition-all"
                  >
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  { label: 'VIP Escort India', href: '/delhi/vip-escort/' },
                  { label: 'Hotel Escort Delhi', href: '/delhi/hotel-escort/' },
                  { label: 'Independent Escort Delhi', href: '/delhi/independent-escort/' },
                  { label: 'VIP Escort Mumbai', href: '/mumbai/vip-escort/' },
                  { label: 'Hotel Escort Mumbai', href: '/mumbai/hotel-escort/' },
                  { label: 'VIP Escort Goa', href: '/goa/vip-escort/' },
                  { label: 'Hotel Escort Goa', href: '/goa/hotel-escort/' },
                  { label: 'VIP Escort Jaipur', href: '/jaipur/vip-escort/' },
                  { label: 'Hotel Escort Jaipur', href: '/jaipur/hotel-escort/' },
                  { label: 'VIP Escort Udaipur', href: '/udaipur/vip-escort/' },
                  { label: 'Call Girl Delhi', href: '/delhi/call-girl/' },
                  { label: 'Call Girl Mumbai', href: '/mumbai/call-girl/' },
                  { label: 'Call Girl Goa', href: '/goa/call-girl/' },
                  { label: 'Call Girl Jaipur', href: '/jaipur/call-girl/' },
                  { label: 'Call Girl Hyderabad', href: '/hyderabad/call-girl/' },
                ].map(({ label, href }) => (
                  <Link
                    key={href}
                    href={href}
                    className="inline-flex items-center gap-1.5 rounded-full border border-neutral-800/60 bg-neutral-900/40 px-3 py-1.5 text-xs font-medium text-neutral-400 hover:border-amber-500/50 hover:text-amber-400 hover:bg-neutral-900 transition-all"
                  >
            ...
            {/* Long-tail keyword rich paragraph — visible text for Googlebot */}
            <div className="mt-8 rounded-xl border border-neutral-800/50 bg-neutral-900/20 p-6 text-xs text-neutral-500 leading-relaxed">
              <strong className="text-neutral-400">Popular searches:</strong>{' '}
              escort service in India, call girl service India, India escort service near me, best escort service India,
              VIP escort India, hotel escort service India, independent escort India, premium escort India,
              escort service Delhi, escort service Mumbai, escort service Goa, escort service Jaipur,
              escort service Udaipur, escort service Hyderabad, escort service Pune, escort service Noida,
              escort service Manali, escort service Jodhpur, escort service Indore, escort service Lucknow,
              call girl Delhi, call girl Mumbai, call girl Goa, call girl Jaipur, call girl Hyderabad,
              24x7 escort India, cheap escort service India, affordable escort India, luxury escort India,
              escort service near me India, female escort India, top escort India, verified escort India.
            </div>
