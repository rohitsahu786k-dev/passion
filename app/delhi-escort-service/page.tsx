  ...
  const faqs = [
    {
      ...
      answer: "Girls of Passion is a professional adult companionship booking support platform in Delhi for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "Is escort service available in Delhi NCR?",
      answer: "Yes. Girls of Passion provides booking support across Delhi, Gurgaon, Noida, and Aerocity. Call or message us on WhatsApp to check available profiles near your hotel."
    },
    {
      question: "How does hotel booking work in New Delhi?",
      answer: "Just share your hotel area (like Saket or Connaught Place) and timing. We will suggest verified profiles available nearby for direct coordination."
    },
    {
      question: "Are profiles verified in Delhi?",
      answer: "Yes. Every companion profile is checked to make sure clients get a reliable and genuine booking experience."
    },
    {
      question: "Can I book a companion in Gurgaon or Noida?",
      answer: "Yes, our service network covers Gurgaon and Noida sectors as well. You can request availability for NCR locations anytime."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.8}
        reviewCount={185}
        url="https://www.girlsofpassion.in/delhi-escort-service/"
        faqs={faqs}
      />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 py-2.5 text-center text-xs font-semibold uppercase tracking-widest text-black">
          💎 Premium & Discreet 100% Verified Profiles in Delhi
        </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Delhi
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Delhi Escort Service</strong> and <strong className="text-white">Delhi Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Delhi area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  If you are visiting Delhi for business, staying in a premium hotel near Aerocity, or exploring the historic spots around Connaught Place, having a local companion can make your trip much more relaxed. We help you book verified companions who know the city well.
                </p>
                <p>
                  Delhi is the busy national capital, hosting business travelers, diplomats, and tourists from all over the world in luxury hotels like Aerocity and South Delhi.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near Connaught Place, Saket & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">Delhi, Delhi</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    <td className="px-6 py-4 font-medium text-white">Available Areas</td>
                    <td className="px-6 py-4">Connaught Place, Saket, Dwarka, Aerocity</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
          ...
          <div className="container-shell">
            <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-extrabold text-white">Verified Companion Profiles in Delhi</h2>
              </div>
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Delhi Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We focus on clear communication and real profiles. Delhi NCR is huge, and our booking support helps you find companions near you quickly. Whether you are staying at a luxury hotel in Vasant Kunj or a private room in Dwarka, we keep your details safe.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                Many visitors stay near the airport or in South Delhi hotels. We provide direct coordination so you do not have to worry about hotel entry or late hours booking.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Delhi</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Delhi:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["Connaught Place","Saket","Dwarka","Aerocity"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Delhi Escorts Today</h3>
