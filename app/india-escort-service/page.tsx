...
export const metadata: Metadata = buildPageMetadata({
  title: 'Premium India Escort Service | 24x7 Verified Booking',
  description: 'Book premium India escort service 24x7 with verified profiles, discreet support, quick WhatsApp response, hotel coordination, and private booking.',
  path: '/india-escort-service/',
  image: '/assets/photos/luxury-escort-service-india.jpg',
  imageAlt: 'India escort service featured image',
  keywords: [
    'India Escort Service',
    'India Call Girl',
    'Call Girls in India',
    'Premium India Escort Service',
    '24x7 India Escort Booking',
  ],
});
  ...
  const faqs = [
    {
      ...
      answer: "Girls of Passion is a professional adult companionship booking support platform in India for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "In which cities is Girls of Passion active?",
      answer: "We are active in Delhi, Mumbai, Goa, Jaipur, Udaipur, Pune, Chennai, Hyderabad, Noida, Lucknow, and other major cities."
    },
    {
      question: "How to book a companion in India?",
      answer: "Simply reach out to us on WhatsApp, share your city and hotel location, and we will connect you with nearby verified profiles."
    },
    {
      question: "Are all companion profiles checked?",
      answer: "Yes, we verify all companion profiles nationwide to ensure quality and trust."
    },
    {
      question: "Do you offer cash payment across cities?",
      answer: "Yes, cash-on-meet option is available in all our active cities."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.8}
        reviewCount={195}
        url="https://www.girlsofpassion.in/india-escort-service/"
        faqs={faqs}
      />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 py-2.5 text-center text-xs font-semibold uppercase tracking-widest text-black">
          💎 Premium & Discreet 100% Verified Profiles in India
        </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in India
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">India Escort Service</strong> and <strong className="text-white">India Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in India area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Travelling across India for leisure or business? Girls of Passion offers a trusted network of verified companions in all major hubs. We coordinate bookings smoothly wherever you go.
                </p>
                <p>
                  Our nationwide network connects travelers and business executives with verified adult companions in all major Indian metro cities and tourist capitals.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near Delhi NCR, Mumbai & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">India, India</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    <td className="px-6 py-4 font-medium text-white">Available Areas</td>
                    <td className="px-6 py-4">Delhi NCR, Mumbai, Goa, Jaipur, Udaipur, Bangalore</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our India Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We are India's premium companion booking network, focused on verified profiles, absolute privacy, and polite communication. We operate in all key tourist and business cities.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                We coordinate with premium hotels, resorts, and villas across India, ensuring safe and hassle-free companionship.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in India</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in India:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["Delhi NCR","Mumbai","Goa","Jaipur","Udaipur","Bangalore"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book India Escorts Today</h3>
