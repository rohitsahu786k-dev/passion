...
export const metadata: Metadata = buildPageMetadata({
  title: 'Premium Dehradun Escort Service | 24x7 Verified Booking',
  description: 'Book premium Dehradun escort service 24x7 with verified profiles, discreet support, quick WhatsApp response, hotel coordination, and private booking.',
  path: '/dehradun-escort-service/',
  image: '/assets/photos/luxury-escort-service-dehradun.jpg',
  imageAlt: 'Dehradun escort service featured image',
  keywords: [
    'Dehradun Escort Service',
    'Dehradun Call Girl',
    'Call Girls in Dehradun',
    'Premium Dehradun Escort Service',
    '24x7 Dehradun Escort Booking',
  ],
});
...
export default function DehradunEscortPage() {
  const phone = '+919999900115';
  const whatsapp = '919999900115';
  const whatsappUrl = `https://wa.me/${whatsapp}?text=Hello%20Girls%20of%20Passion%2C%20I%20want%20to%20book%20a%20verified%20Dehradun%20escort%20service.`;

  const faqs = [
    {
      question: "What is Girls of Passion?",
      answer: "Girls of Passion is a professional adult companionship booking support platform in Dehradun for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "Do you cover hotels on Rajpur Road Dehradun?",
      answer: "Yes. We cover Rajpur Road, Jakhan, Clock Tower, and Mussoorie Road hotel hubs."
    },
    {
      question: "How to book a companion in Dehradun?",
      answer: "WhatsApp us your details. We will share verified profiles available in the valley today."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, we verify all companion listings to ensure photos match."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.7}
        reviewCount={127}
        url="https://www.girlsofpassion.in/dehradun-escort-service/"
        faqs={faqs}
      />
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Dehradun
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Dehradun Escort Service</strong> and <strong className="text-white">Dehradun Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Dehradun area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Staying on Rajpur Road or visiting the peaceful hills of Dehradun? A friendly, verified companion can make your stay much warmer. We provide direct and private booking support.
                </p>
                <p>
                  Dehradun is a peaceful valley city, acting as the gateway to Mussoorie, hosting tourists, students, and wellness retreats.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near Rajpur Road, Mussoorie Road & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">Rajpur Road, Mussoorie Road, Clock Tower, Jakhan</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Dehradun Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We connect clients with verified profiles in Dehradun. Our booking support is fast, clean, and helps you coordinate with companions near Rajpur Road or Jakhan.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                We coordinate with major hotels, cottages, and hill resorts in Dehradun and on the way to Mussoorie.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Dehradun</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Dehradun:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["Rajpur Road","Mussoorie Road","Clock Tower","Jakhan"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Dehradun Escorts Today</h3>
