...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/assets/photos/luxury-escort-service-lucknow.jpg', width: 1200, height: 630 }],
  },
  twitter: {
...
const companionProfiles = [
  ...
  },
  {
    ...
    image: '/assets/photos/classy-escort-service-lucknow.jpg',
  ...
  },
  {
    ...
    height: '5\'4"',
    nationality: 'Indian',
    image: '/assets/photos/premium-escorts-lucknow.jpg',
  ...
  },
  {
    ...
    image: '/assets/photos/vip-escort-lucknow.jpg',
          ...
          <div className="container-shell relative z-10 grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="flex flex-col justify-center">
              ...
              {/* Intro paragraphs */}              <div data-seo-answer-summary className="mt-5 max-w-3xl rounded-lg border border-amber-500/20 bg-neutral-900/40 p-5 text-sm leading-7 text-neutral-300">
                <p>
                  <strong className="text-amber-400">Lucknow Call Girl</strong> is the primary booking keyword for this page. Adults can use Girls of Passion to check Call Girls in Lucknow, Lucknow escorts services, verified profile coordination, cash payment availability, quick deals, free hotel coordination, and private 24/7 booking support.
                </p>
                <p className="mt-3">
                  This page is optimized for answer-first search results by clearly covering who the service is for, where it is available, how booking support works, and why users searching for Lucknow Call Girl or Call Girls in Lucknow can find relevant city-specific information here.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                <Image 
                  src="/assets/photos/luxury-escort-service-lucknow.jpg" 
                  alt="Lucknow Escort Service Premium companion profile"
                  fill
                  priority
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">Premium adult companionship in Lucknow</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    <td className="px-6 py-4 font-medium text-white">Main Location</td>
                    <td className="px-6 py-4">Lucknow, Uttar Pradesh</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
              ...
              {companionProfiles.map((p) => (
                <div key={p.name} className="group overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/40 hover:border-amber-500/50 hover:shadow-[0_0_15px_rgba(245,158,11,0.1)] transition-all duration-300">
                  <div className="relative h-80 w-full overflow-hidden">
                    <Image 
                      src={p.image} 
                      alt={`${p.name} - Lucknow Escort Companion`}
                      fill
        ...
        <section className="py-12 bg-neutral-900/30 border-b border-neutral-900">
          <div className="container-shell">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
              ...
              <a href="/lucknow/independent-escort/" className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-4 hover:border-amber-500/30 transition-colors"><p className="font-semibold text-white text-sm">Independent Escort</p><p className="text-xs text-amber-400 mt-1">From Rs. 8,000</p></a>
              <a href="/lucknow/call-girl/" className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-4 hover:border-amber-500/30 transition-colors"><p className="font-semibold text-white text-sm">Call Girl Service</p><p className="text-xs text-amber-400 mt-1">From Rs. 6,000</p></a>
              <a href="/lucknow/outcall-escort/" className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-4 hover:border-amber-500/30 transition-colors"><p className="font-semibold text-white text-sm">Outcall Escort Service</p><p className="text-xs text-amber-400 mt-1">From Rs. 9,000</p></a>
            </div>
          </div>
        </section>
