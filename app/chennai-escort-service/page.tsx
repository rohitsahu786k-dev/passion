...
export const metadata: Metadata = {
  title: 'Chennai Escort Service | Verified Booking',
...
export default function ChennaiEscortPage() {
  ...
  const localBusinessSchema = {
    ...
    description: 'Book a discreet Chennai escort service with Girls of Passion. Verified profiles, private booking, 24x7 support, and premium companionship across Chennai.',
    url: '/chennai-escort-service/',
    telephone: phone,
    address: {
      '@type': 'PostalAddress',
