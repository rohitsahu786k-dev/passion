...
export default function ChennaiEscortPage() {
  const phone = '+919999900108';
  const whatsapp = '919999900108';
  ...
  const faqs = [
    {
      ...
      answer: "Girls of Passion is a professional adult companionship booking support platform in Chennai for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "Is companion booking private in Chennai?",
      answer: "Yes. Privacy is our top priority. All booking chats and details are kept confidential and deleted quickly."
    },
    {
      question: "What areas do you cover in Chennai?",
      answer: "We serve T. Nagar, Anna Nagar, Adyar, Guindy, OMR, and major hotel hubs."
    },
    {
      question: "How do I check profile availability?",
      answer: "Message us on WhatsApp to view available verified profiles in your area."
    },
    {
      question: "Can I pay cash in Chennai?",
      answer: "Yes, cash payment is accepted directly on the meeting."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.6}
        reviewCount={143}
        url="https://www.girlsofpassion.in/chennai-escort-service/"
        faqs={faqs}
      />
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Chennai
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Chennai Escort Service</strong> and <strong className="text-white">Chennai Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Chennai area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Visiting Chennai for business or staying at a hotel near T. Nagar or Guindy? Finding a private, verified companion is simple with our platform. We offer discreet bookings with local companions.
                </p>
                <p>
                  Chennai is a coastal business hub known for its IT parks, corporate headquarters, and traditional heritage.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near T. Nagar, Adyar & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">T. Nagar, Adyar, Anna Nagar, OMR, Guindy</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Chennai Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We maintain strict privacy rules for our clients in Chennai. We understand that discretion is key in Chennai. Our team coordinates everything cleanly so you can relax.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                We cover corporate hotels near OMR, luxury hotels in T. Nagar, and airport road business stays.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Chennai</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Chennai:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["T. Nagar","Adyar","Anna Nagar","OMR","Guindy"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Chennai Escorts Today</h3>
