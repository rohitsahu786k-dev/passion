...
export const metadata: Metadata = buildPageMetadata({
  title: 'Premium Guwahati Escort Service | 24x7 Verified Booking',
  description: 'Book premium Guwahati escort service 24x7 with verified profiles, discreet support, quick WhatsApp response, hotel coordination, and private booking.',
  path: '/guwahati-escort-service/',
  image: '/assets/photos/luxury-escort-service-guwahati.jpg',
  imageAlt: 'Guwahati escort service featured image',
  keywords: [
    'Guwahati Escort Service',
    'Guwahati Call Girl',
    'Call Girls in Guwahati',
    'Premium Guwahati Escort Service',
    '24x7 Guwahati Escort Booking',
  ],
});
...
export default function GuwahatiEscortPage() {
  const phone = '+919999900119';
  const whatsapp = '919999900119';
  const whatsappUrl = `https://wa.me/${whatsapp}?text=Hello%20Girls%20of%20Passion%2C%20I%20want%20to%20book%20a%20verified%20Guwahati%20escort%20service.`;

  const faqs = [
    {
      question: "What is Girls of Passion?",
      answer: "Girls of Passion is a professional adult companionship booking support platform in Guwahati for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "Which areas do you cover in Guwahati?",
      answer: "We cover GS Road, Paltan Bazaar, Dispur, Khanapara, and nearby business hotels."
    },
    {
      question: "How can I book a companion in Guwahati?",
      answer: "Reach out on WhatsApp, share your area name, choose a verified profile, and we will confirm details."
    },
    {
    ...
    {
      question: "Are profiles checked in Guwahati?",
      answer: "Yes, we check profiles to maintain service quality and trust."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.7}
        reviewCount={128}
        url="https://www.girlsofpassion.in/guwahati-escort-service/"
        faqs={faqs}
      />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 py-2.5 text-center text-xs font-semibold uppercase tracking-widest text-black">
          💎 Premium & Discreet 100% Verified Profiles in Guwahati
        </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Guwahati
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Guwahati Escort Service</strong> and <strong className="text-white">Guwahati Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Guwahati area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Staying near GS Road for work or transit? Our companion booking service offers a safe way to book verified companions. We provide fast WhatsApp support and direct coordination.
                </p>
                <p>
                  Guwahati is the gateway to Northeast India, located on the Brahmaputra River, hosting business travelers and transit tourists.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near GS Road, Paltan Bazaar & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">GS Road, Paltan Bazaar, Dispur, Khanapara</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Guwahati Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  We focus on safe, verified profiles in Guwahati. Our team understands local transit schedules and coordinates bookings in business hotels around GS Road and Dispur.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                We cover hotels, guest stays, and business suites in GS Road, Paltan Bazaar, and Khanapara.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Guwahati</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Guwahati:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["GS Road","Paltan Bazaar","Dispur","Khanapara"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Guwahati Escorts Today</h3>
