...
export default function HyderabadEscortPage() {
  ...
  const localBusinessSchema = {
    ...
    description: 'Book a discreet Hyderabad escort service with Girls of Passion. Verified profiles, private booking, 24x7 support, and premium companionship across Hyderabad.',
    url: '/hyderabad-escort-service/',
    telephone: phone,
    address: {
      '@type': 'PostalAddress',
