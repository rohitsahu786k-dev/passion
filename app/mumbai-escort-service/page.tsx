...
export const metadata: Metadata = buildPageMetadata({
  title: 'Premium Mumbai Escort Service | 24x7 Verified Booking',
  description: 'Book premium Mumbai escort service 24x7 with verified profiles, discreet support, quick WhatsApp response, hotel coordination, and private booking.',
  path: '/mumbai-escort-service/',
  image: '/assets/photos/luxury-escort-service-mumbai.jpg',
  imageAlt: 'Mumbai escort service featured image',
  keywords: [
    'Mumbai Escort Service',
    'Mumbai Call Girl',
    'Call Girls in Mumbai',
    'Premium Mumbai Escort Service',
    '24x7 Mumbai Escort Booking',
  ],
});
  ...
  const faqs = [
    {
      ...
      answer: "Girls of Passion is a professional adult companionship booking support platform in Mumbai for adults who want private, secure, and premium companion coordination."
    },
        {
      question: "How can I book a call girl in Mumbai?",
      answer: "You can browse profiles and contact us via WhatsApp. Share your current area or hotel location, and we will share available options."
    },
    {
      question: "Do you cover North and South Mumbai?",
      answer: "Yes, we provide booking assistance in Bandra, Andheri, Powai, BKC, and South Mumbai areas like Colaba."
    },
    {
      question: "Is cash payment accepted in Mumbai?",
      answer: "Yes, we offer cash payment options for client convenience and privacy."
    },
    {
      question: "Are the companion profiles real?",
      answer: "Yes. We verify all profiles to ensure they match their photos, so you get exactly what you choose."
    }
  ];
  ...
  return (
    <>
      ...
      <CitySchema
        ...
        rating={4.8}
        reviewCount={172}
        url="https://www.girlsofpassion.in/mumbai-escort-service/"
        faqs={faqs}
      />
      ...
      <div className="bg-neutral-950 text-neutral-200 selection:bg-amber-500 selection:text-black">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 py-2.5 text-center text-xs font-semibold uppercase tracking-widest text-black">
          💎 Premium & Discreet 100% Verified Profiles in Mumbai
        </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl lg:leading-[1.1]">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 text-2xl md:text-3xl lg:text-4xl font-semibold">
                  Premium Adult Companionship in Mumbai
                </span>
              </h1>
              
              <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-300">
                Our <strong className="text-amber-400">Mumbai Escort Service</strong> and <strong className="text-white">Mumbai Call Girl</strong> booking are available 24/7. We help you connect with verified profiles for private booking, hotel visits, and direct contact with local companions in Mumbai area.
              </p>

              <div className="mt-8 space-y-4 text-base leading-relaxed text-neutral-300">
                <p>
                  Whether you are staying near BKC for corporate meetings, hanging out in Bandra West, or booked at a beachside hotel in Juhu, a friendly local companion is the best way to unwind. We connect you with verified profiles in Mumbai.
                </p>
                <p>
                  Mumbai is the financial capital of India, famous for its Bollywood industry, Marine Drive, and upscale hotels facing the Arabian Sea.
                </p>
                <p>
            ...
            <div className="flex flex-col gap-6 lg:justify-center">
              ...
              <div className="relative h-72 overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <p className="text-xs text-neutral-300">Available near Bandra, Andheri & Luxury Hotels</p>
                </div>
              </div>
              ...
              <table className="w-full border-collapse text-left text-sm text-neutral-300">
                ...
                <tbody className="divide-y divide-neutral-800/60">
                  ...
                  <tr className="hover:bg-neutral-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4">Bandra, Andheri, Powai, BKC, Colaba</td>
                  </tr>
                  <tr className="hover:bg-neutral-900/40 transition-colors">
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Why Choose Our Mumbai Escort Booking?</h2>
              
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-neutral-300">
                <p>
                  Our platform is known for fast WhatsApp responses and simple rules. Mumbai is a fast-paced city where timing is everything. We ensure your booking is handled quickly, with complete privacy.
                </p>
                <p>
            ...
            <div className="flex flex-col justify-center gap-6 rounded-xl border border-neutral-800 bg-neutral-900/30 p-8">
              ...
              <p className="text-sm leading-relaxed text-neutral-300">
                From Juhu beach resorts to Colaba boutique hotels, our team handles coordination smoothly, respecting client preferences and safety.
              </p>
        ...
        <section className="py-20 border-b border-neutral-900">
          <div className="container-shell">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-white">Areas We Cover in Mumbai</h2>
              <div className="mt-3 h-1 w-20 bg-amber-500 mx-auto rounded-full" />
              <p className="mt-4 text-sm text-neutral-300 leading-relaxed">
                We coordinate companion bookings across all key sectors, commercial hubs, and luxury hotels in Mumbai:
              </p>
            </div>

            {/* Location Grid */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {["Bandra","Andheri","Powai","BKC","Colaba"].map((loc) => (
        ...
        <section className="py-20 bg-neutral-900/20 border-b border-neutral-900">
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white mb-4">Book Mumbai Escorts Today</h3>
